		...
		<table class="table">
			<tr>
				...
				<td width="80%" class="m2"><input type="text" name="Mname"
					...
					<br>
				<span class='ck'>*이름은 한글만 가능해요</span></td>
			</tr>
			<tr>
				<td width="20%" class="m1"><b>이메일</b></td>
				<td width="80%" class="m2"><input type="text" name="Email"
					id="email" onkeyup="" placeholder="Email" class="form-control"
					style="width: 23%">
					<button type="button" class="btn btn-success" id="emailCheck"
						name="emailCheck" onclick="ajax_email()">이메일 중복 체크</button> <br>
				<span class='ck' id="id_result">이메일양식 XXX@XXX.XXX</span></td>
			</tr>
			<tr>
				<td width="20%" class="m1"><b>비밀번호</b></td>
				<td width="80%" class="m2"><input type="password" name="Pwd"
					id="Pwd" placeholder="비밀번호" class="form-control" style="width: 20%">
					<br>
			...
			<tr>
				...
				<td width="80%" class="m2"><input type="text" name="Mpost"
			...
			<tr>
				...
				<td width="80%" class="m3"><input type="text" name="Maddr1"
					id="Maddr1" placeholder="도로명주소" class="form-control"
					style="width: 50%"><br> <input type="text"
