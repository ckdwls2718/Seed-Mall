...
<div class="container" style="height:auto; overflow: auto;">
	...
	<form name="mf" id="mf" action="join" method="post">
		...
		<table class="table">
		<tr>
				<td width="26%" class="m1"><b>개인정보처리방침</b></td>
				<td width="74%" class="m2"><textarea readonly>개인정보처리방침
...
2) 시행일자 : 2018년 05월 01일 </textarea>
			...
			<tr>
				<td width="26%" class="m1"><b>서비스 이용약관 동의</b></td>
				<td width="200%" class="m2"> <textarea readonly>제1조(목적) 이 약관은 업체 회사(전자상거래 사업자)가 운영하는 업체 사이버 몰(이하 “몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리․의무 및 책임사항을 규정함을 목적으로 합니다.
			...
			<tr>
				<td colspan="2" class="text-center" id="last">
					<button class="btn btn-outline-danger" type="button"
						onclick="window.close()" style="margin:20px 15px 20px;">창닫기</button>				
				</td>
			</tr>
