...
<div class="container mt-3" style="height:600px;overflow: auto;">
	...
	<p class="text-center my-4">
		<input type="button" class="btn btn-success btn-sm" value="공지 쓰기" onclick="location.href='noticeWriteForm'">
	</p>
	<!-- 검색 폼 시작----------------------------- -->
		...
		<div class="row py-3">
			<div class="col-md-9 text-center">
				<form name="searchF" action="notice" onsubmit="return check()">
					...
					<input type="hidden" name="bpage" value="${paging.bpage}">
					<!-- -------------------------------------------------- -->
	...
	<table class="table table-striped" >
		...
		<c:if test="${noticeArr ne null and not empty noticeArr}">
			...
			<tr>
				...
				<td width="50%">
					<!-- 글제목 ---------------- -->
					<a href="view/<c:out value="${notice.nidx}"/>">
						<c:if test="${fn:length(notice.ntitle)>20}">
		...
		<tfoot>
				...
				<span class="text-danger"><c:out value="${paging.bpage}"/></span> 
