            ...
            <div class="container d-flex flex-wrap text-end">
              ...
              <div class="flex-shrink-0 dropdown">
                <a href="#" class="d-block link-dark text-decoration-none dropdown-toggle " data-bs-toggle="dropdown" aria-expanded="false">
                  <img src="./assets/몬스테라.jpg" alt="mdo" width="32" height="32" class="rounded-circle" style="margin-top:3px">
                </a>
        ...
        <header class="py-3 mb-4 border-bottom ">
            <div class="container d-flex flex-wrap" >
              <a href="#"  class="d-flex align-items-center mb-3 mb-lg-2 me-lg-auto text-dark text-decoration-none" style="margin-left:2em">
                <img src="./assets/logo-removebg-preview.png" style="width:100%;height:70px" >
              </a>
              <div class="me-lg-7 align-items-center">
                <img src="./assets/name-removebg-preview.png" style="width:100%">
              </div>
