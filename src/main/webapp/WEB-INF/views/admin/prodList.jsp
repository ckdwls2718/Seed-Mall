...
<div class="container" style="text-align: center">
	...
	<div class="row">
		<div class="col-md-12">
			<h2 class="text-center m-4" style="margin: 1em">:::상품 목록 [Admin
				Page]:::</h2>
					...
					<c:if test="${prodArr ne null and not empty prodArr}">
						<c:forEach var="prod" items="${prodArr}" varStatus="status">
							<tr>
								...
								<td>${prod.pname}</td>
								<c:if test="${prod.pidx eq prodImageArr[status.index].pidx}">
									<td width="15%"><a href="a" target="_blank"> <img
											src="${myctx}/resources/product_images/${prodImageArr[status.index].pimage}"
								...
								<td><del>
										...
										%할인</span></td>
								<td><a href="javascript:edit('${prod.pidx}')">수정</a>| <a
									href="#" onclick="remove('${prod.pidx}')">삭제</a></td>
							</tr>
						</c:forEach>
					</c:if>
					<!-- ------------------------ -->
