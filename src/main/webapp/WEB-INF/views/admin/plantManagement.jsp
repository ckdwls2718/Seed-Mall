		...
		<form action="plantManagementUpdate" method="post" enctype="multipart/form-data">
			...
			<table class="table">
				...
				<tr>
					...
					<td>
						<input type="text" name="pcomment" value="">
					</td>
				</tr>
				<tr>
					<td>퍼센트</td>
				...
				<tr>
					<td>이미지</td>
					<td>
						<img src="${myctx}/resources/plant_images/${plant.plantImage}" width="300px">
					</td>
					<td>
						<input type="file" name="plantImage" onchange="setThumbnail(event)">
